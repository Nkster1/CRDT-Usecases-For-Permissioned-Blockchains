...
//
//
// console.log(readProduct(ids[5]));
//
// addErrounousePartToProduct(ids[5], readProduct(ids[2]));
// addErrounousePartToProduct(ids[5], readProduct(ids[7]));
// removeErrounousePartFromProduct(ids[5], readProduct(ids[2]));
//
// console.log(readProduct(ids[5]));
//
// addErrounousePartToProduct(ids[5], readProduct(ids[9]));
//
//
// console.log(readProduct(ids[5]));
//
